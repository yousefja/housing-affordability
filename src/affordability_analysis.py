...
df_analysis['Affordable_Price'] = df_analysis.Household_Median_Income * 3
df_analysis['Affordability_Gap'] = df_analysis.Affordable_Price - 
...
'''
Another metric, the HPI divides the median house price by the median household income. 
...
'''
group by zip, calculate HPI per zip

# affordability ratio: price-to-income
df_analysis['PIR'] = df_analysis['Price'] / 
